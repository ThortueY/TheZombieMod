...
public class ArenaSaveYAML {
    ...
    private ZombieMod pluginInstance;
    private YamlConfiguration yamlConfiguration = new YamlConfiguration();
    String arenaName;

    final String keyArenaPosition = "arenasPosition";
    ...
    public void createArenaConfig(String arenaName) {
        ...
        try {
            ...
            yamlConfiguration.save(configFileArena);
    ...
    public void setArenaPosition1(String arenaName, int posX1, int posY1, int posZ1) {
        ...
        String arenaNameInConfig = null;

        if (arenaName != yamlConfiguration.get("arenaName",arenaNameInConfig)) {
